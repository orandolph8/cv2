...
predictor = dlib.shape_predictor(r"C:\Users\orand\OneDrive\Pictures\Pictures\shape_predictor_68_face_landmarks.dat")
...
while True:
    ...
    else: img = cv2.imread(r'OneDrive/Pictures/Pictures/1.webp')
